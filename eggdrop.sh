...
if [ -f $eggnick.conf ]
then
 echo "Configuration file with name $eggnick.conf already exits at $HOME. Please remove it or choose a different eggdrop bot nick."
 exit
fi

cat << EOF > $eggnick.conf
#! /path/to/executable/eggdrop
# Generated by https://www.xShellz.com
...
chmod +x $eggnick.conf
./eggdrop -m $eggnick.conf

echo "Now please visit $ircserver:$ircport and type /msg $eggnick hello to make yourself the owner of bot."

echo "Eggdrop created, successfully. If you face any kind of error please contact $_author. "
